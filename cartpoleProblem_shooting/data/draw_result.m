...
% figure (88)
% grid on
% plot(nTrajs_list, errorResult.firstEuler(startIdx : size(errorResult.firstEuler, 2)), Marker="o");
% hold on
% plot(nTrajs_list, errorResult.secondEuler(startIdx : size(errorResult.firstEuler, 2)), Marker="o");
% plot(nTrajs_list, errorResult.firstRk4(startIdx : size(errorResult.firstEuler, 2)), Marker="o");
% plot(nTrajs_list, errorResult.secondRk4(startIdx : size(errorResult.firstEuler, 2)), Marker="o");
% ylim([0 0.5])
