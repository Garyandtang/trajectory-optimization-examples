...
hold on
plot(nTrajs_list, errorResult.secondEuler(1 : size(errorResult.firstEuler, 2)), "-", Marker="<",LineWidth=1.5);
plot(nTrajs_list, errorResult.firstRk4(1 : size(errorResult.firstEuler, 2)), "-", Marker="s",LineWidth=1.5);
plot(nTrajs_list, errorResult.secondRk4(1 : size(errorResult.firstEuler, 2)), "-", Marker="v",LineWidth=1.5);
grid on
...
hold on
plot(nTrajs_list, timeResult.secondEuler(1 : size(errorResult.firstEuler, 2)), "-", Marker="<",LineWidth=1.5);
plot(nTrajs_list, timeResult.firstRk4(1 : size(errorResult.firstEuler, 2)), "-", Marker="s",LineWidth=1.5);
plot(nTrajs_list, timeResult.secondRk4(1 : size(errorResult.firstEuler, 2)), "-", Marker="v",LineWidth=1.5);
grid on
legend("1st-Euler", "2nd-Euler","1st-RK4","2nd-RK4",'Interpreter','latex','FontSize',10)
